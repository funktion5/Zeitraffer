...
def test_get_image_range_uses_filename_scan_only(
	...
	(camera_directory / "unknown-format.jpg").touch()

	(camera_directory / "notes.txt").touch()

	(camera_directory / "directory.jpg").mkdir()
	...
	result = images_module.get_image_range("Test-Camera")
...
def test_validate_images_removes_empty_files(
	...
	first_image.write_bytes(b"image data")

	empty_image.touch()

	second_image.write_bytes(b"more image data")
...
def test_find_interval_images_returns_all_images_inside_daily_window(
	...
	assert result == [
		camera_directory / "camera_26-09-15_10-30-00-00.jpg",
		camera_directory / "camera_26-09-15_11-15-00-00.jpg",
		camera_directory / "camera_26-09-15_12-02-00-00.jpg",
		camera_directory / "camera_26-09-15_13-30-00-00.jpg",
	]
...
def test_find_interval_images_respects_target_tolerance(
	...
	inside_tolerance = camera_directory / "camera_26-09-15_10-30-00-00.jpg"

	outside_tolerance = camera_directory / "camera_26-09-16_10-29-59-00.jpg"
	...
	assert result == [inside_tolerance]
...
def test_find_interval_images_scans_directory_once(
	...
	(camera_directory / "camera_26-09-15_12-00-00-00.jpg").touch()

	(camera_directory / "camera_26-09-16_12-00-00-00.jpg").touch()
...
def test_find_interval_images_returns_images_in_chronological_order(
	...
	assert result == [
		camera_directory / "camera_26-09-15_11-00-00-00.jpg",
		camera_directory / "camera_26-09-15_13-00-00-00.jpg",
		camera_directory / "camera_26-09-16_10-45-00-00.jpg",
		camera_directory / "camera_26-09-16_12-30-00-00.jpg",
	]
...
def test_find_interval_images_isolated_returns_validated_images(
	...
	valid_image = camera_directory / "camera_26-09-15_12-00-00-00.jpg"

	empty_image = camera_directory / "camera_26-09-15_12-10-00-00.jpg"
